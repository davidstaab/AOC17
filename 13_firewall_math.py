...
if __name__ == '__main__':
    ...
    # Each scanner starts in the "hot seat" where it'll catch the packet. It leaves the seat and returns 2(`rng` - 1) ps
    # later. The packet reaches the hot seat every integer multiple of (`depth` + `delay`) ps after it starts moving.
